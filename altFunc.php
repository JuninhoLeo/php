...
$sql = "SELECT funcionarios.nome, funcionarios.endereco, funcionarios.rg, funcionarios.cpf, funcionarios.telefone, funcionarios.email, funcionarios.cidade, funcionarios.uf, usuarios.usuario, usuarios.senha
        FROM funcionarios
        ...
        <form id="login-form" class="form" action="updFunc.php" method="POST">
            ...
            <div class="form-row">
                <div class="col-md-4">
                    ...
                    <input type="password" name="senha" id="senhaNov" class="form-control" required>
                </div>
            </div>
            <br>
            <div class="form-group">
                <div>
                    <input type="button" name="voltar" class="btn btn-outline-danger" value="Voltar" onclick="javascript:location.href='listFunc.php'">
