            ...
            <section class="row" id="hoteis">
                <ul style="list-style: none">
                    <div class="row" id="pularlinha">
                        <h1 style="color: white">Editar Funcionário</h1>
                        <table class="table">
                            ...
                            foreach ($pdo->query($sql) as $row) {
                                ...
                                <tr>
                                    ...
                                    <td scope="row" class="text-center">
                                        <button type="button" class="btn btn-outline-warning" id="btRes" onclick="javascript:location.href='altFunc.php?id='+<?php echo $row['usuario_id'] ?>">
                                            Alterar</button>
                                    </td>
                                </tr>
