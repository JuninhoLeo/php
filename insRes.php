...
<body>
    ...
    <form class="container-fluid" id="frmInsRes" name="frmInsRes" method="POST" action="insRes.php">
        ...
        <input type="button" name="voltar" class="btn btn-outline-danger" value="Voltar" 
        onclick="javascript:location.href='home.php'">
        <input type="button" name="Limpar" class="btn btn-outline-warning" value="Limpar" 
        onclick="javascript:location.href='reserva.php'">
